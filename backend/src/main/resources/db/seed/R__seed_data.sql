...
VALUES ('Anna', 'Kowalska', 'anna.kowalska@example.com', '501100001',
        '$2a$12$rKqh3gMWzdPTHj5bPCMOa.n1tnVriPkHW7i.WuXi5vfazkUX2AZoy', 'TUTOR', NULL),
       ...
       ('Tomasz', 'Adamski', 'tomasz.adamski@example.com', '502200001',
        '$2a$12$rKqh3gMWzdPTHj5bPCMOa.n1tnVriPkHW7i.WuXi5vfazkUX2AZoy', 'STUDENT', NULL),
       ...
       ('Adam', 'Szczur', 'admin@example.com', '503300001',
        '$2a$12$rKqh3gMWzdPTHj5bPCMOa.n1tnVriPkHW7i.WuXi5vfazkUX2AZoy', 'ADMIN', NULL),
...
WITH u AS (SELECT id, email
           FROM users)
INSERT
INTO tutors (user_id, bio, hourly_rate, offers_online, offers_in_person, city)
...
VALUES
    ...
    ((SELECT user_id FROM t WHERE user_id = 21), (SELECT id FROM s WHERE id = 23),
     ...
     CURRENT_DATE - 4, '10:00', '11:00', 'IN_PERSON', 'COMPLETED', 'Analiza obrazów impresjonistów.', 'Bardzo fajne i zwięzłe notatki, dziękuję!', 100.00, 'PAID', (CURRENT_DATE - 4) + TIME '11:30:00'),
    ...
    ((SELECT user_id FROM t WHERE user_id = 25), (SELECT id FROM s WHERE id = 26),
     ...
     CURRENT_DATE - 5, '15:00', '16:00', 'IN_PERSON', 'COMPLETED', 'Rozpoznawanie samogłosek i sylabizowanie.', 'Super podejście do dziecka!', 90.00, 'PAID', (CURRENT_DATE - 5) + TIME '16:30:00'),
    ((SELECT user_id FROM t WHERE user_id = 28), (SELECT id FROM s WHERE id = 31),
     (SELECT id FROM sub WHERE subject_name = 'Matematyka'),
     CURRENT_DATE - 6, '16:00', '17:30', 'ONLINE', 'COMPLETED', 'Funkcje kwadratowe.', 'Na maksa logicznie wytłumaczone.', 127.50, 'PAID', (CURRENT_DATE - 6) + TIME '17:40:00'),
    ...
    ((SELECT user_id FROM t WHERE user_id = 29), (SELECT id FROM s WHERE id = 34),
     ...
     CURRENT_DATE - 7, '16:00', '17:00', 'ONLINE', 'COMPLETED', 'Francuska wymowa - nosówki.', 'Bardzo fajne materiały.', 95.00, 'PAID', (CURRENT_DATE - 7) + TIME '17:10:00'),
    ...
    ((SELECT user_id FROM t WHERE user_id = 30), (SELECT id FROM s WHERE id = 31),
     (SELECT id FROM sub WHERE subject_name = 'Biologia'),
     CURRENT_DATE - 8, '11:00', '12:00', 'IN_PERSON', 'COMPLETED', 'Cytologia - budowa komórki', 'Mnóstwo ciekawostek naukowych.', 75.00, 'PAID', (CURRENT_DATE - 8) + TIME '12:15:00'),
    ((SELECT user_id FROM t WHERE user_id = 1), (SELECT id FROM s WHERE id = 32),
     (SELECT id FROM sub WHERE subject_name = 'Matematyka'),
     CURRENT_DATE - 9, '16:00', '17:00', 'IN_PERSON', 'COMPLETED', 'Równania liniowe.', 'Jasno i przejrzyście', 80.00, 'PAID', (CURRENT_DATE - 9) + TIME '17:00:00'),
    ...
    ((SELECT user_id FROM t WHERE user_id = 17), (SELECT id FROM s WHERE id = 34),
     ...
     CURRENT_DATE - 10, '16:00', '17:00', 'ONLINE', 'COMPLETED', 'Powtórzenie przed egzaminem.', 'Syn czuje się wreszcie przygotowany.', 120.00, 'PAID', (CURRENT_DATE - 10) + TIME '17:30:00'),
