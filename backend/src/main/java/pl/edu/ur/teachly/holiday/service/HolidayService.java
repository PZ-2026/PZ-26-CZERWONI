...
public class HolidayService {
    ...
    public HolidayResponse updateHoliday(Integer holidayId, HolidayRequest request) {
        Holiday holiday = holidayRepository.findById(holidayId)
                .orElseThrow(() -> new pl.edu.ur.teachly.common.exception.ResourceNotFoundException("Nie znaleziono święta"));
    ...
    public void deleteHoliday(Integer holidayId) {
        if (!holidayRepository.existsById(holidayId)) {
            throw new pl.edu.ur.teachly.common.exception.ResourceNotFoundException("Nie znaleziono święta");
        }
